            ...
            >
                <form className="flex flex-column flex-full">
                    <div className="Form-inputs pb4">
                        <p className="text-paragraph">{t`Saved queries and other things that depend on this ${objectType} will continue to work, but this ${objectType} will no longer be selectable from the query builder.`}</p>
